...
class Conv_Codec(ConvCrossScaleCodec):
...
if __name__ == "__main__":
    ...
    codec = Conv_Codec(args.device, config)   
...
"""
python evaluate_conv_perf.py \
    --model_path /scratch/eys9/output/csvq-tcm-merge18k-scale-baseline \
    --data_path /scratch/eys9/data/DNS_CHALLENGE/processed_yz

python evaluate_conv_perf.py \
    --model_path /scratch/eys9/output/csvq-tcm-residual18k-scale-baseline \
    --data_path /scratch/eys9/data/DNS_CHALLENGE/processed_yz

python evaluate_conv_perf.py \
    --model_path /scratch/eys9/output/csvq-tcm-dpp-residual18k-scale-baseline \
    --data_path /scratch/eys9/data/DNS_CHALLENGE/processed_yz
"""