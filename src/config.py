...
def init_args():
    ...
    parser.add_argument('--h_dims', nargs='+', type=int, default=[16,16,24,24,32,64])
    ...
    parser.add_argument("--swin_h_dims", nargs='+', type=int, default=[45,45,72,96,192,384])
    # parser.add_argument("--swin_h_dims", type=list, default=[36,72,144,144,192,384])
    parser.add_argument("--swin_depth", type=int, default=2)
    parser.add_argument("--swin_heads", nargs='+', type=int, default=[3,3,6,12,24])

    parser.add_argument("--window_size", type=int, default=4)
    parser.add_argument("--mlp_ratio", type=float, default=4.)    
    
    parser.add_argument("--proj", nargs='+', type=int, default=[4,4,2,2,2,2])
    ...
    parser.add_argument("--wb_project_name", type=str, default=None)
    ...
    parser.add_argument("--test_bs", type=int, default=24)
