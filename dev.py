...
# model = RVQCodecs(in_dim=2, in_freq=192, h_dims=[45,72,96,144,192,384], # [16,16,24,24,32,64]
#                 max_streams=6, backbone="swinT", # swinT
#                 overlap=2, num_rvqs=18, codebook_dim=8, codebook_size=1024, l2norm=True,)
...
model = RVQCodecs(in_dim=2, in_freq=192, h_dims=[45,72,96,144,192,384], #[64,64,96,96,192,384], # [16,16,24,24,32,64]
                ...
                overlap=4, num_rvqs=18, codebook_dim=8, codebook_size=1024, l2norm=True,
                conv_depth=1)
# print(model)
...
if __name__ == "__main__":
    ...
    outputs = model.forward_one_step(
        x, None, num_streams=6, freeze_codebook=False
    )
