"""Window Attentions are mostly borrowed from https://github.com/microsoft/Swin-Transformer"""
import torch
import torch.nn as nn
import numpy as np

from timm.models.layers import trunc_normal_, to_2tuple
from models.swin.compress import PatchMerging, PatchSplit, PatchEmbed, PatchDeEmbed

subsample_map = {"down": PatchMerging, "up": PatchSplit}

class SwinTransformerLayer(nn.Module):
    """Shifted-Window-Attention Layer: Encoder/Decoder Backbone"""
    def __init__(self, 
                 in_dim,
                 out_dim,
                 depth,
        ...
        self.subsample = subsample_map[subsample](in_dim, out_dim, scale_factor, norm_layer) \
