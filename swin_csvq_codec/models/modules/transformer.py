"""Swin Transformer Modules Implementation"""
import torch
import torch.nn as nn
import numpy as np

from timm.models.layers import trunc_normal_, to_2tuple
from models.modules.downsample import PatchMerging, PatchSplit
...
class SwinTLayer(nn.Module):
    def __init__(self, 
        ...
        self.subsample = subsample(in_dim, out_dim, norm_layer) if subsample is not None else None
