...
from modules.TF_modules import TCM_Module
...
class CSVQ_Decoder(nn.Module):
    def __init__(self, in_channels=2, ch_mult=(4,4,8,8,16,16), Groups=6, F=201, num_res_block=6, num_GRU_layers=2,
        ...
        self.quantizer0 = Quantization(G=Groups, ch=ch_mult[-1]*in_channels, F=F//2**self.B, 
        ...
        self.fuse_module = nn.ModuleList([CSVQ_Fuse(G=Groups, C=ch_mult[self.B-i-1]*in_channels, F_= F//2**(self.B-i), 
